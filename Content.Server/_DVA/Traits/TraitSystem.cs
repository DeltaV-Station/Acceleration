...
using Content.Shared._DVA.Traits.Conditions;
using Content.Shared._DVA.Traits.Effects;
...
namespace Content.Server._DVA.Traits;
...
public sealed partial class TraitSystem : EntitySystem
{
    ...
    private void OnPlayerSpawnComplete(PlayerSpawnCompleteEvent args)
    {
        ...
        var disabledTraits = new Dictionary<ProtoId<DVTraitPrototype>, List<string>>();
    ...
    /// </summary>
    private HashSet<ProtoId<DVTraitPrototype>> ValidateTraits(
        EntityUid player,
        IReadOnlySet<ProtoId<DVTraitPrototype>> selectedTraits,
        ICommonSession? session,
        string? jobId,
        string? speciesId,
        Dictionary<ProtoId<DVTraitPrototype>, List<string>> disabledTraits)
    {
        var validTraits = new HashSet<ProtoId<DVTraitPrototype>>();
        var totalPoints = 0;
        var traitCount = 0;
        var categoryTraitCounts = new Dictionary<ProtoId<DVTraitCategoryPrototype>, int>();
        var categoryPointTotals = new Dictionary<ProtoId<DVTraitCategoryPrototype>, int>();
    ...
    private bool ValidateCategoryLimits(
        DVTraitPrototype trait,
        Dictionary<ProtoId<DVTraitCategoryPrototype>, int> categoryTraitCounts,
        Dictionary<ProtoId<DVTraitCategoryPrototype>, int> categoryPointTotals,
    ...
    /// </summary>
    private bool CheckConditions(DVTraitPrototype trait, TraitConditionContext ctx, List<string> rejectionReasons)
    {
    ...
    /// </summary>
    private void ApplyTrait(EntityUid player, DVTraitPrototype trait)
    {
