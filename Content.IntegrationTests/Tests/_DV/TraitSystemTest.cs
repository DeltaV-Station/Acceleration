...
using Content.Server._DVA.Traits;
...
namespace Content.IntegrationTests.Tests._DVA.Traits;
...
";
    ...
    public async Task AddCompsEffect_AddsComponents()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var trait = protoMan.Index(new ProtoId<DVTraitPrototype>("TestTraitAddComps"));
    ...
    public async Task OverrideCompsEffect_OverwritesComponent()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var trait = protoMan.Index(new ProtoId<DVTraitPrototype>("TestTraitOverrideComps"));
            var ctx = CreateEffectContext(entMan, protoMan, factory, player);
    ...
    public async Task RemCompsEffect_RemovesComponents()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var trait = protoMan.Index(new ProtoId<DVTraitPrototype>("TestTraitRemComps"));
            var ctx = CreateEffectContext(entMan, protoMan, factory, player);
    ...
    public async Task SpawnItemInHandEffect_SpawnsItem()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var trait = protoMan.Index(new ProtoId<DVTraitPrototype>("TestTraitSpawnItem"));
    ...
    public async Task RespectsConflicts()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var selectedTraits = new HashSet<ProtoId<DVTraitPrototype>>
            {
                "TestTraitConflictA",
                "TestTraitConflictB",
            };
            ...
            var validTraits = (HashSet<ProtoId<DVTraitPrototype>>)method?.Invoke(traitSys,
                new object[] { player, selectedTraits, null, null, null, new Dictionary<ProtoId<DVTraitPrototype>, List<string>>() });
