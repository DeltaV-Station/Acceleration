...
/// </summary>
[Prototype("dvTrait")]
public sealed partial class DVTraitPrototype : IPrototype
{
    [IdDataField]
    ...
    /// </summary>
    [DataField(required: true)]
    public ProtoId<DVTraitCategoryPrototype> Category;
    ...
    /// </summary>
    [DataField]
    public List<ProtoId<DVTraitPrototype>> Conflicts = new();
}
