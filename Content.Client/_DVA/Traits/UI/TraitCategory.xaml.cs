...
{
    public event Action<ProtoId<DVTraitPrototype>, bool>? OnTraitToggled;

    private readonly DVTraitCategoryPrototype _category;
    private readonly List<DVTraitPrototype> _allTraits;
    private readonly Dictionary<ProtoId<DVTraitPrototype>, TraitEntry> _traitEntries = new();
    ...
    public TraitCategory(DVTraitCategoryPrototype category, List<DVTraitPrototype> traits)
    {
    ...
    private void OnTraitEntryToggled(ProtoId<DVTraitPrototype> traitId, bool selected)
    {
    ...
    public void SetTraitSelected(ProtoId<DVTraitPrototype> traitId, bool selected)
    {
    ...
    /// </summary>
    public IEnumerable<ProtoId<DVTraitPrototype>> GetSelectedTraitIds()
    {
    ...
    /// </summary>
    public bool TraitMeetsConditions(ProtoId<DVTraitPrototype> traitId)
    {
