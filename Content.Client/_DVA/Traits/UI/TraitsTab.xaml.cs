...
public sealed partial class TraitsTab : BoxContainer
{
    ...
    /// </summary>
    public event Action<HashSet<ProtoId<DVTraitPrototype>>>? OnTraitsChanged;

    private readonly Dictionary<ProtoId<DVTraitCategoryPrototype>, TraitCategory> _categoryUis = new();
    private readonly HashSet<ProtoId<DVTraitPrototype>> _selectedTraits = new();
    ...
    private void OnProtoReload(PrototypesReloadedEventArgs args)
    {
        ...
        if (args.WasModified<DVTraitPrototype>() || args.WasModified<DVTraitCategoryPrototype>())
            RefreshTraits();
    }
    ...
    private void PopulateCategories()
    {
        ...
        var categories = _prototype.EnumeratePrototypes<DVTraitCategoryPrototype>()
            .OrderBy(c => c.Priority)
            .ThenBy(c => Loc.GetString(c.Name))
            .ToList();

        var traitsByCategory = _prototype.EnumeratePrototypes<DVTraitPrototype>()
    ...
    private void OnTraitToggled(ProtoId<DVTraitPrototype> traitId, bool selected)
    {
    ...
    private void RevertTraitToggle(ProtoId<DVTraitPrototype> traitId)
    {
        var trait = _prototype.Index(traitId);
        if (_categoryUis.TryGetValue(trait.Category, out var categoryUi))
        {
    ...
    private void UpdateCategoryStats(ProtoId<DVTraitCategoryPrototype> categoryId)
    {
    ...
    private void RecalculateStats()
    {
        ...
        var previouslySelected = new HashSet<ProtoId<DVTraitPrototype>>(_selectedTraits);
    ...
    /// </summary>
    public void SetSelectedTraits(IEnumerable<ProtoId<DVTraitPrototype>> traits)
    {
