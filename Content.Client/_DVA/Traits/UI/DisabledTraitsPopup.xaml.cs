...
public sealed partial class DisabledTraitsPopup : FancyWindow
{
    ...
    public DisabledTraitsPopup(Dictionary<ProtoId<DVTraitPrototype>, List<string>> disabledTraits)
    {
    ...
    private void InitializeUI(Dictionary<ProtoId<DVTraitPrototype>, List<string>> disabledTraits)
    {
    ...
    private void PopulateDisabledTraits(Dictionary<ProtoId<DVTraitPrototype>, List<string>> disabledTraits)
    {
