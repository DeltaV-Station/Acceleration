...
public sealed partial class DisabledTraitsPopupSystem : EntitySystem
{
    ...
    private void OpenDisabledTraitsPopup(Dictionary<ProtoId<DVTraitPrototype>, List<string>> disabledTraits)
    {
